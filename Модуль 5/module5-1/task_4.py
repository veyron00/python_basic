...
number_points = int(input('Введите количество баллов за экзамены: '))
if (place_in_list >= 1) and (place_in_list <= 10) and (number_points >= 290):
  print('Поздравляем, Вы поступили!')
  print('Бонусом Вам будет начисляться стипендия')
elif (place_in_list >= 1) and (place_in_list <= 10) and (number_points < 290):
  print('Поздравляем, Вы поступили!')
